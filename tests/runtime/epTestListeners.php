...
class epTestListeners extends epTestRuntime {
    ...
    function testRegisterListeners_g() {
        ...
        $this->assertTrue($this->m->register('ezpdo\\tests\\runtime\\eptListener'));
        ...
        $this->assertTrue($this->m->unregister('ezpdo\\tests\\runtime\\eptListener') == 2);
    }
    ...
    function testEventDispatch_g() {
        ...
        $this->assertTrue($this->m->unregister('ezpdo\\tests\\runtime\\eptListener') == 1);
    }
